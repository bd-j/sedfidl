...
for iz=0,n_elements(z)-1 do begin
   ...
   spawn,'mkdir '+rundir+zdir
   scriptname='bc03_scripts/script_bc03allimf_grid_onedust_exp_z'+$
   ...
   printf,1,'mv bc03*_exp*_z'+strcompress(string(round(z[iz]*100),format='(I3.3)'),/remove_all)+'* '+$
          rundir+zdir
   close,1
