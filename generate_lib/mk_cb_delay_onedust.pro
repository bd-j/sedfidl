...
for iz=0,n_elements(z)-1 do begin
   ...
   scriptname='cb07_scripts/script_cb07allimf_grid_onedust_delay_z'+$
   ...
   printf,1,'mv cb07*_delay*_z'+strcompress(string(round(z[iz]*100),format='(I3.3)'),/remove_all)+'* '+$
          rundir+zdir
   close,1
